import { BarChart3, CalendarDays, CheckCircle2, ClipboardList, Download, FolderKanban, LayoutList, Moon, Plus, Sun, Upload } from 'lucide-react'
...
export default function Sidebar({ tasks, onNewTask, onImport, onExport }: SidebarProps) {
